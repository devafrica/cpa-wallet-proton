...
class Config {
    constructor() {
        ...
        this.minimumFeePerByte = 500000 / this.feePerByteChunkSize;
        /**
         * Mapping of height to mixin maximum and mixin minimum
         */
        this.mixinLimits = new MixinLimits_1.MixinLimits([
            /* Height: 440,000, minMixin: 0, maxMixin: 100, defaultMixin: 3 */
            new MixinLimits_1.MixinLimit(0, 1, 3, 1),
            /* At height of 620000, static mixin of 7 */
            new MixinLimits_1.MixinLimit(20, 1, 3, 1),
            /* At height of 800000, static mixin of 3 */
            new MixinLimits_1.MixinLimit(50, 1, 3, 1),
